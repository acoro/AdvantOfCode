...
print("Advent Of Code 2023 - Exercice 7_1")
...
Liste_Paire=[]
Liste_Haute_Carte=[]
# A-> A, K -> B, Q->C, J-> D, T -> E, 9->F 8->G 7->H 6->I 5->L 4->M 3->N 2->O )
Dico_Brelan=["AAA","BBB","CCC","DDD","EEE","FFF","GGG","HHH","III","LLL","MMM","NNN","OOO"]
Dico_Carre=["AAAA","BBBB","CCCC","DDDD","EEEE","FFFF","GGGG","HHHH","IIII","LLLL","MMMM","NNNN","OOOO"]
Gains=0
Indice=1
...
while Lecture_Boucle:
    ...
    if Fichier_Ligne :
       ...
       Liste_Cartes = Liste_Cartes.replace("J","D")
